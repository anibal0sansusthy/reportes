...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'PEROSNAS ATENDIDOS POR MEDICOS'
        },
        tooltip: {
        ...
        series: [{
			...
			<?php
			$sql=mysql_query("select * from reporte_medico where cantidad!=1000");
			while($res=mysql_fetch_array($sql)){
			?>
			
                ['<?php echo $res['apaterno']; ?>', <?php echo $res['cantidad'] ?>],
...
<br><br>
<center><a href="ejemplo3Medico.php">Ver grafico 3</a></center>
