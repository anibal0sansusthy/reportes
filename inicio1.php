  ...
  <head>
   ...
   <body>
    <div class="ui pointing menu"><a href="http://localhost:3000/indexreportegrafico" class="item">Inicio Grafico</a>
      <a href="http://localhost/reportes/inicioEdad.php" class="item">Reportes Graficos edades</a>
    ...
    <div class="ui container grid stackable">
      <div class="ten wide column">
        <h2 class="ui header blue dividing">Reporte de Especialidades</h2>
          <div class="form-nuevocargo">
            <form action="controlador.php" method="post" class="ui form">
              <div class="ui field">
